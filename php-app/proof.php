 ...
 * proof attachment. If a legacy record's PDF file is missing on disk, dynamically
 * recovers and generates an attestation document so users never hit a broken PDF or 404.
 *
 * Usage:
...
// Clean any active output buffers to prevent notices from corrupting binary output
while (ob_get_level()) {
    ob_end_clean();
}
